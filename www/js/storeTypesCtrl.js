...
.controller('StoreTypes', function($scope,$ionicModal,$state,$http,$rootScope,$ionicFilterBar,ionicToast,$ionicLoading,$ionicPopup,httpManager,loadManager) {
	...
	$scope.saveMeetNEvents = function (){
		...
		var parameters ={ID:'000',
						categoryID: $('#categoryID').val(),
						eventname:$('#eventTitle').val(),
						locationID:$('#locationID').val(),
						ConveyedBy:$('#conveyedBy').val(),
						description:$('#description').val(),
						viewedBy:'everyone',
						venue:$('#venue').val(),
						contactnum1:$('#contactNo1').val(),
						DateTo : $scope.selectedDates[0].getDate() + ':' + $scope.selectedDates[0].getMonth() + ':' + $scope.selectedDates[0].getFullYear(),
						DateFrom : $scope.selectedDates[0].getDate() + ':' + $scope.selectedDates[0].getMonth() + ':' + $scope.selectedDates[0].getFullYear(),
						TimeTo : $scope.selectedDates[0].getDate() + ':' + $scope.selectedDates[0].getMonth() + ':' + $scope.selectedDates[0].getFullYear(),
						TimeFrom : $scope.selectedDates[0].getDate() + ':' + $scope.selectedDates[0].getMonth() + ':' + $scope.selectedDates[0].getFullYear(),
		...
		httpManager.postRequester('SaveMeetNEvents',parameters,getCategoryForStoreTypeSuccessCallback);
	};
